    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
      ...
      <div className="b2b-card rounded-2xl p-4 sm:p-6 border border-[#7C3AED]/25 bg-[#7C3AED]/5 max-w-3xl mx-auto flex items-start gap-4">
        ...
        <div className="space-y-1 text-xs sm:text-sm">
          <h4 className="font-bold text-slate-900">No Web Subscriptions</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
        {/* Free Starter */}
        <div className="b2b-card rounded-3xl p-8 border border-slate-200 flex flex-col justify-between">
          ...
          <button
            ...
            className="w-full mt-8 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold border border-slate-200 text-xs transition-colors"
          >
            App Coming Soon
          </button>
        </div>
        ...
        <div className="b2b-card rounded-3xl p-8 border-2 border-[#7C3AED] flex flex-col justify-between relative shadow-xl shadow-[#7C3AED]/10 bg-white">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-4xl font-extrabold text-slate-900">$11</span>
        ...
        <div className="b2b-card rounded-3xl p-8 border border-slate-200 flex flex-col justify-between">
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-bold text-slate-900">Team & Gym Coach</h3>
              <p className="text-xs text-slate-500 mt-1">
